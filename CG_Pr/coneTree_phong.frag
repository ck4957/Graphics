...
//Material Properties
uniform vec4 amb_col_coneTree;
uniform vec4 diff_col_conTree;
...
void main()
{
	...
	vec4 A, D, S;
	A = amb_col_coneTree * amb_ref_coff *  amb_light_col;
	D = light_col * diff_col_conTree * diff_ref_coff * max(0,cos_theta);
